...
COMMENT ON COLUMN :api_schema_name.question.рште IS 'Подсказка';
...
COMMENT ON COLUMN :api_schema_name.questionnaire_question.possible_answer_id IS 'Идентификатор ответа';
COMMENT ON COLUMN :api_schema_name.questionnaire_question.question_id IS 'Идентификатор вопроса';
COMMENT ON COLUMN :api_schema_name.questionnaire_question.answer IS 'Возможный ответ';
COMMENT ON COLUMN :api_schema_name.questionnaire_question.is_truthful IS 'Правдивый ответ';
COMMENT ON COLUMN :api_schema_name.questionnaire_question.explanation IS 'Объяснение';
